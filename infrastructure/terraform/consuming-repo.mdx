...
Local invocation pairs aws-vault with [Doppler](/security/tools/doppler) for runtime secret injection — the canonical chain from the [check-placement page](/infrastructure/tofu-check-placement):
...
<CardGroup cols={2}>
  ...
  <Card title="Terraform check placement" icon="list-check" href="/infrastructure/tofu-check-placement">

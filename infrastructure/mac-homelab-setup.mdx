...
<Step title="Confirm">
Re-run the preceding capture. Option 12 now carries your real hostname, and the
...
discoverable identity. Turn it off only on networks you trust, such as your own

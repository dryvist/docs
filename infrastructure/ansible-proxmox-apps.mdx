...
| --- | --- | --- |
| [Proxmox config](/infrastructure/ansible-proxmox) hands off ready hosts | HAProxy (tcp/udp front door), Cribl Edge (collection), Cribl Stream (routing) | Cribl Stream forwards over HEC to Splunk Enterprise |

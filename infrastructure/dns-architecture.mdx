...
description: "How names resolve across the homelab: Technitium answers for internal names and forwards everything else over encrypted DoH to Cloudflare and Google."

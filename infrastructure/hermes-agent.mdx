...
- **Context7 MCP**: A keyless hosted MCP connection at `https://mcp.context7.com/mcp` (an API key only raises rate limits; the header is only rendered when a key is set).

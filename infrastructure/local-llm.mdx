...
<Note>
  **This is not the same "local AI" as the
  [AI development pipeline](/architecture/ai-pipeline).** That one is the MLX
  server on *this MacBook* (also port 11434), wired through Bifrost for coding
  tasks. This page is the **homelab GPU** stack — a different machine, a bigger

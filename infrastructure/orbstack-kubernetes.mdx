...
| Upstream | Downstream |
| --- | --- |
| AI coding tools (Claude Code, Gemini, VS Code, Copilot) emit OTLP to the cluster | Local Stream forwards over HEC to the [homelab Splunk](/observability/ansible-splunk); Edge-managed also reports to Cribl Cloud |

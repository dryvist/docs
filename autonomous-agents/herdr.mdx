...
description: "herdr runs as a homelab service: one runtime holds every coding agent's terminal, a Slack bridge answers blocked agents, and a web dashboard approves them."

---
title: "Runtime"
description: "Two places an agent runs: a Nix-built OCI image on the Mac, and a static pool of LXC guests on Proxmox that pull work from a queue behind an allowlisting egress proxy."

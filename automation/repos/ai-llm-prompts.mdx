...
> One public catalog owns Dryvist-authored prompt text. Runtime repositories own schedules, credentials, deployment IDs, and app logic.
...
<Card
  ...
  icon="book"
  href="https://github.com/dryvist/ai-llm-prompts/blob/v0.1.0/index.md">

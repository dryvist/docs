...
The reusable workflows check out the catalog at its pinned release commit, select an asset from `automation/`, and remove its OKF frontmatter before
passing the prompt to the selected model. Local workflow YAML still owns triggers, permissions, publishing, and provider configuration.
...
<CardGroup cols={2}>
  ...
  <Card title="Prompt catalog" icon="book" href="/automation/repos/ai-llm-prompts">

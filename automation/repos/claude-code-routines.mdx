...
| Docs Sync | Daily 3:13 AM | Reads 48h of estate change; opens a public `docs` PR (scrubbed) and updates internal documentation |
...
| Env var | Purpose |
| --- | --- |
| `GH_TOKEN` | Short-lived GitHub App installation token for the `gh` CLI |

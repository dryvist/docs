...
| --- | --- | --- |
| `OPENROUTER_API_KEY` (secret) | `_all_repos` | Auth for `claude-code-action` to call Claude via OpenRouter |
| `OPENROUTER_BASE_URL` (secret) | `_all_repos` | OpenRouter endpoint |
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="key" href="https://github.com/JacobPEvans/ai-workflows/blob/main/docs/AUTHENTICATION.md">
    Why OpenRouter, not OAuth tokens; cost controls; alternative providers.
  </Card>
</CardGroup>

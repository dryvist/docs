...
| **`Qwen3.6-27B-4bit`** | 16.1 GB (Swap tier) | Dense Swap | **Recommended to retire.** Decodes at 23–27 tok/s (4× slower than the 35B MoE), produces low-effort code reviews, and fills no unique capability niche. |

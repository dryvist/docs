---
title: "Local LLM"
description: "One strategy for local inference: a fast resident model on each laptop, and an always-on Apple Silicon host serving the large tier to the LAN."
page_type: "overview"
---

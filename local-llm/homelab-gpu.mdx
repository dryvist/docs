...
<Warning>
This page describes the previous single-GPU serving stack. It is being
superseded by a routed, multi-tier serving design; treat the specifics here as
the earlier architecture rather than the current target.
</Warning>

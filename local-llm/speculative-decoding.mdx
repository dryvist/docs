...
description: "Multi-token prediction on Apple Silicon: why decode is bandwidth-bound, what a trained draft head changes, and why concurrency couples rather than caps."

...
description: "A sourced reference for picking a local model: what the evidence says, the gates that override benchmarks, and how to verify what actually loads."
page_type: "reference"
---

...
| --- | --- | --- |
| [Proxmox config](/infrastructure/repos/ansible-proxmox) or [Splunk on AWS](/observability/tf-splunk-aws) hands over ready hosts | Splunk Enterprise, the AI-observability TA + apps | Cribl Stream forwards events over HEC into this Splunk |

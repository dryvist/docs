...
flowchart LR
  ...
  click SP "/observability/ansible-splunk" "Splunk install + indexes"
  click CCO "https://github.com/JacobPEvans/cc-edge-claude-code-otel" "Claude Code OTEL pack" _blank
  click CCP "https://github.com/JacobPEvans/cc-edge-copilot-otel" "Copilot OTEL pack" _blank
  click CAG "https://github.com/JacobPEvans/cc-edge-gemini-antigravity-io" "Gemini Antigravity pack" _blank
  click CCV "https://github.com/JacobPEvans/cc-edge-vscode-io" "VS Code pack" _blank

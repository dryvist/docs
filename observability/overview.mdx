...
flowchart LR
  ...
  classDef tool  fill:#FBF7EE,stroke:#2F7E78,stroke-width:2px,color:#0B1D2A;
  classDef pack  fill:#FFE7DC,stroke:#E06B4A,stroke-width:2px,color:#0B1D2A;
  classDef route fill:#F4EFE6,stroke:#0B1D2A,stroke-width:1.5px,color:#0B1D2A;
  ...
  linkStyle 8,9 stroke:#2F7E78,stroke-width:2px;
```

...
| `cribl-edge` (Mac native) | Native macOS Cribl Edge install (Nix-managed) | macOS unified logs, system metrics, thermal, powermetrics, battery via [`cc-edge-the-mac-pack`](/observability/repos/cc-edge-the-mac-pack) | Stream (downstream of pack) |

---
title: "macOS host"
description: "Flakes-based nix-darwin configuration for macOS: the top of the Nix stack, importing home-manager and nix-ai."
page_type: "repo"
---
...
`nix-darwin` is the top-level entry point for the Mac. One `darwin-rebuild switch` updates packages, fonts, app preferences, shell, and dock: anything that has a system-level reflection.
...
<Card
  ...
  icon="github"
  href="https://github.com/JacobPEvans/nix-darwin">

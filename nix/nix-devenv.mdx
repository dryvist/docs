---
title: "Dev shells"
description: "Reusable per-project Nix dev shells: OpenTofu, Ansible, Kubernetes, Python, and ML, one flake per stack."
page_type: "repo"
---
...
<Card
  ...
  icon="github"
  href="https://github.com/JacobPEvans/nix-devenv">

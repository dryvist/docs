...
flowchart LR
  ...
  classDef gateway  fill:#FFE7DC,stroke:#E06B4A,stroke-width:2.5px,color:#0B1D2A;
  classDef cluster  fill:#FBF7EE,stroke:#2F7E78,stroke-width:2px,color:#0B1D2A;
...
flowchart LR
  ...
  classDef src   fill:#FBF7EE,stroke:#2F7E78,stroke-width:2px,color:#0B1D2A;
  ...
  classDef dr    fill:#F4EFE6,stroke:#E6B35A,stroke-width:2px,color:#0B1D2A;

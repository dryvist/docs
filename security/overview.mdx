...
| **OpenBao** | The T2 runtime manager (in bring-up): the primary AI/machine credential interface, SSH CA for automation, and the global flow-lease authority | [openbao](/security/tools/openbao) |

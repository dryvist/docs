...
| --- | --- | --- |
| `terraform-apply` | `secret/infra/*`, `secret/platform/{dns,traefik}`, plus `aws/sts/tf-proxmox` and `aws/sts/openbao-iac-admin` | same |

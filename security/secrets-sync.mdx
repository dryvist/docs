...
flowchart LR
  ...
  classDef trigger fill:#FBF7EE,stroke:#2F7E78,stroke-width:2px,color:#0B1D2A;
  classDef gate    fill:#FFE7DC,stroke:#E06B4A,stroke-width:2.5px,color:#0B1D2A;
  classDef job     fill:#F4EFE6,stroke:#0B1D2A,stroke-width:1.5px,color:#0B1D2A;
  classDef abort   fill:#FFE7DC,stroke:#C25638,stroke-width:2px,color:#0B1D2A;

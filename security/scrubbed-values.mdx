...
The same gate runs on the draft PRs opened by the [Docs Sync routine](/automation/repos/claude-code-routines), so machine-authored content is held to the same bar as anything authored by hand.

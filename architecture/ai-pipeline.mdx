...
- [ai-assistant-instructions](https://github.com/JacobPEvans/ai-assistant-instructions) — universal AI configuration layer (rules, permissions, workflows, agents)
- [claude-code-plugins](https://github.com/JacobPEvans/claude-code-plugins) — commands, skills, hooks, agents for Claude Code
- [claude-code-routines](https://github.com/JacobPEvans/claude-code-routines) — scheduled remote-agent routines on Claude.ai
- [ai-workflows](https://github.com/JacobPEvans/ai-workflows) — reusable GitHub Copilot agentic workflows
- [nix-ai](https://github.com/JacobPEvans/nix-ai) — Nix package and config layer for every AI coding tool
- [raycast-smart-issue](https://github.com/JacobPEvans/raycast-smart-issue) — Raycast extension for AI-drafted GitHub issues via local MLX

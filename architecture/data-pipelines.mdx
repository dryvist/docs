...
flowchart LR
  ...
  style HAProxy fill:#102937,stroke:#E06B4A,color:#F4EFE6
  style Edge1 fill:#102937,stroke:#4FB3A9,color:#F4EFE6
  style Edge2 fill:#102937,stroke:#4FB3A9,color:#F4EFE6
...
flowchart LR
  ...
  style Net fill:#4FB3A9,stroke:#2F7E78,stroke-width:2px,color:#F4EFE6
  style HA fill:#102937,stroke:#E06B4A,color:#F4EFE6
  style EA fill:#102937,stroke:#4FB3A9,color:#F4EFE6
  style EB fill:#102937,stroke:#4FB3A9,color:#F4EFE6
  style Splunk fill:#2F7E78,stroke:#4FB3A9,stroke-width:2px,color:#F4EFE6
```

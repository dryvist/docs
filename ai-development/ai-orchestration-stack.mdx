...
- **LangChain and CrewAI are libraries.** You do not "deploy" them. You `pip
  install` them into app code. In this homelab they live together in one
...
OpenAI-compatible endpoint, an external API, or both. It is never forced onto a shared
...
- Writing app code → **LangChain** for primitives, **CrewAI** for

...
- Owns the **autonomy-resilience rules** hardened after the 2026-07 overnight runs —
  [`subagent-resilience`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/subagent-resilience.md)
  (probe before fan-out, bounded concurrency, mandatory solo fallback),
  [`loop-cadence`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/loop-cadence.md)
  (every recurring loop gates itself on a durable min-interval marker), and
  [`delegation-trust`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/delegation-trust.md)
...
- Owns the **shared behavioral base (soul)** for every agent surface —
  [`soul.md`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/soul.md)

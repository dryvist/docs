...
description: "How to fan a plan or diff out to three independent model families: the Codex CLI, the Antigravity (agy) CLI for Gemini, and a local MLX model, for adversarial review, plus the gotcha each one hits."
page_type: "how-to"
---

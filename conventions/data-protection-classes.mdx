...
[Observability and alerting](/conventions/observability-and-alerting):
mechanisms emit facts, Splunk decides what's wrong. Absence of a report is
caught the same way — by comparing what ran against what was expected to
run, not by watching each mechanism individually.

## Related

- [Observability and alerting](/conventions/observability-and-alerting) —
  the collection and alerting path this contract feeds into.
- [Status taxonomy](/conventions/status-taxonomy) — the vocabulary for
  what "live," "declared," and "planned" mean elsewhere in these docs.

...
2. Start the branch there: `git flow feature start <name>`. Include the GitHub issue number when one exists — `feature/123-fix-inventory-loader`. Never invent an issue number; use a short descriptive slug for issue-less maintenance.

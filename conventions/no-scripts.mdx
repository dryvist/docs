...
Inlined logic in a YAML `run:` step, a Markdown copy-paste block, or a heredoc smuggling a Bash loop
is the worst of every world. It is untestable, unlintable, and undiscoverable. The rules below apply
to every repo across the org.

...
See [`agentsmd/rules/pre-commit.md`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/pre-commit.md) for the auto-loaded rule that codifies these decisions for AI agents.
...
- [`dryvist/ai-assistant-instructions` `agentsmd/rules/pre-commit.md`](https://github.com/dryvist/ai-assistant-instructions/blob/main/agentsmd/rules/pre-commit.md) — auto-loaded rule for AI agents

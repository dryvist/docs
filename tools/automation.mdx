...
`mintlify-docs-update` is a Claude Code skill that scans `JacobPEvans` (and `dryvist`), diffs the
result against this site, and proposes the missing pages. It lives in
`.claude/skills/mintlify-docs-update/` and is invoked manually via `/mintlify-docs-update` or on a
cadence by the global `auto-maintain` orchestrator.
...
<CardGroup cols={2}>
<Card
  title="mintlify-page-author"
  icon="pen-nib"
  href="https://github.com/JacobPEvans/docs/issues/2">
...
<Card
  title="mintlify-visual-audit"
  icon="chart-bar"
  href="https://github.com/JacobPEvans/docs/issues/3">
...
<Card
  title="mintlify-mermaid-theme"
  icon="diagram-project"
  href="https://github.com/JacobPEvans/docs/issues/4">
...
<Card
  title="mintlify-nav-sync"
  icon="bars-staggered"
  href="https://github.com/JacobPEvans/docs/issues/5">
...
<Card
  title="mintlify-build-guard"
  icon="shield-halved"
  href="https://github.com/JacobPEvans/docs/issues/6">
...
<Card
  ...
  icon="github"
  href="https://github.com/JacobPEvans/docs/issues?q=is%3Aissue+is%3Aopen+label%3Askill">
